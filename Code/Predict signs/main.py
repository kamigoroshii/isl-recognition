    ...
    while True:
        ...
        if results:
            for i in results:
                ...
                label_lang = Label(f1, text="Voice Language:", font=("arial", 10, "bold"))
                label_lang.place(x=255, y=85)
                
                # Language dropdown
                language_var = StringVar(f1)
                language_var.set("English")  # default value
                
                language_dropdown = ttk.Combobox(f1, textvariable=language_var, state="readonly", width=18)
                language_dropdown['values'] = multilingual_tts.get_available_languages()
                language_dropdown.place(x=255, y=105)
                
                def on_language_change(event):
                    selected_language = language_var.get()
                    multilingual_tts.set_language(selected_language)
                ...
                btn2w2.place(x=255, y=135, width=150, height=30)

                btn3w2 = ttk.Button(f1, text="Translate speech", command=rr_main)
                btn3w2.place(x=255, y=180, width=150, height=30)
                ...
                btn9w2.place(x=255, y=270, width=150, height=30)

                def quit():
                    window2.destroy()

                btn9w2 = ttk.Button(f1, text="Exit", command=quit)
                btn9w2.place(x=255, y=315, width=150, height=30)
